...
This is a **6-layer command stack** that governs how every UnyKorn system is designed, evaluated, built, branded, sold, and maintained. It is not one giant prompt — it is a layered architecture where each layer has a specific role and authority.
...
```
01 Constitution  >  02 Governor  >  03 Builder  >  06 Commerce  >  04 Brand Skin  >  05 Feature Review
```

The Constitution is absolute. The Governor enforces the Constitution. The Builder executes what the Governor approves. Commerce ensures it can sell and spread. The Brand Skin customizes the result. The Feature Review audits everything.
...
**Prompt Constitution v1.1**  
Created for the UnyKorn ecosystem — Helios, FTH, UnyKorn, xxxiii, NIL33, Y3K.

---

*One constitution. One governor. One shared shell. Six brands. Zero drift. Ready to sell.*
